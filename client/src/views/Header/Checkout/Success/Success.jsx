  ...
  return (
    <Container className={classes.successContaier}>
      <Box className={classes.sucessBox}>
        ...
        <Box className={classes.content}>Ihre Bestellnummer lautet: {order.increment_id}.</Box>
        <Box className={classes.content}>
        Sie erhalten in Kürze eine Bestellbestätigungs-E-Mail.
        </Box>
        <Box>
        <Button variant="contained" onClick={() => navigate('/')}>Einkauf fortsetzen</Button>
        </Box>
      </Box>
    </Container>
  );
